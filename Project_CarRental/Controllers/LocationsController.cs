...
namespace Project_CarRental.Controllers
{
    ...
    public class LocationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LocationId,City,Adress,TelephoneNumber")] Location location)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LocationId,City,Adress,TelephoneNumber")] Location location)
        {
